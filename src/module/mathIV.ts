...
class MatIV {
  ...
  scale = (mat: Float32Array, vec: Vec3) => {
    const dest = this.create();
    dest[0] = mat[0] * vec[0];
    dest[1] = mat[1] * vec[0];
    dest[2] = mat[2] * vec[0];
  ...
  translate = (mat: Float32Array, vec: Vec3) => {
    const dest = this.create();
    dest[0] = mat[0];
    dest[1] = mat[1];
    dest[2] = mat[2];
  ...
  rotate = (mat: Float32Array, angle: number, axis: Vec3) => {
